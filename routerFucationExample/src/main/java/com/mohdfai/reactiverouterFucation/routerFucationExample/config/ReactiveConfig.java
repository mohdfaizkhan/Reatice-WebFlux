...
public class ReactiveConfig
{
    ...
    {
        return RouterFunctions.route(RequestPredicates.GET("rest/employee/all"),
                        routerHandlers::getAll)
                .andRoute(
                        RequestPredicates.GET("rest/employee/{id}"),
                        routerHandlers::getId
                )
                .andRoute(
                        RequestPredicates.GET("rest/employee/{id}/events"),
